...
-- =====================================================
-- TABLAS HOJA DE VIDA INTELIGENTE (Enero 2026)
-- Módulo de reclutamiento y gestión de aspirantes
-- =====================================================
...
-- TABLA DE EXPERIENCIA ASPIRANTE
...
-- TABLA DE REFERENCIAS ASPIRANTE
...
-- TABLA DE HOJA VIDA PDF (Metadatos)
...
-- TABLA VIRTUAL FTS5: hojas_vida_fts (Búsqueda Full-Text)
...
-- TABLA DE TALLAS EMPLEADO (si no existe)
CREATE TABLE IF NOT EXISTS tallas_empleado (
    ...
    talla_overall TEXT,
    talla_chaqueta TEXT,
    talla_calzado_numero INTEGER,
    ancho_calzado TEXT,
    tipo_calzado_preferido TEXT,
    talla_guantes TEXT,
    talla_casco TEXT,
    talla_gafas TEXT,
    observaciones TEXT,
...
CREATE INDEX IF NOT EXISTS idx_tallas_empleado ON tallas_empleado(empleado_id);
";
