...
description: Apply when compiling the project or verifying build errors. Requires the specific build command with binary logging for all compilation tasks.
---
